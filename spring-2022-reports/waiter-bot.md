...
After it has collected all items, it uses the Odometry it stored at the beginning of the order and set and send another ```MoveBaseGoal```. Once it returns to its original location, to the user. 
